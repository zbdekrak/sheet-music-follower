...
if __name__ == "__main__":
    ...
    for i in range(2):
      ...
      song, values, length = generate_song_wrapper(X, Y, N, [0,6])
      wav.write("./test/test" + str(i+1) + ".wav", 16000, song.astype(np.float32))
      with open("./test/test" + str(i+1) + ".json", "w") as file:
